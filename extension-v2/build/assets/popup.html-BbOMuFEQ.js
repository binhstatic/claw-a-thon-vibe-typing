import { C as CLASS_CACHE, A as ATTRIBUTES_CACHE, N as NAMESPACE_HTML, y as get_prototype_of, z as get_descriptors, d as delegate, k as push, o as onMount, h as sibling, m as child, i as if_block, v as each, a as template_effect, b as delegated, e as append, f as pop, j as from_html, q as set, g as get, n as set_text, B as index, D as comment, E as first_child, s as state, F as text, w as setupTheme, x as mount } from "./theme-B3OQhyhs.js";
import { P as ProtocolClient } from "./ProtocolClient-CGKQZBsb.js";
import { M as MASKS } from "./protocol-D7dFRlSf.js";
const whitespace = [..." 	\n\r\f \v\uFEFF"];
...
function Popup($$anchor, $$props) {
  ...
  var node_3 = child(span_4);
  {
    var consequent_2 = ($$anchor2) => {
      var text_4 = text("Đang kiểm tra server...");
      append($$anchor2, text_4);
    };
    var consequent_3 = ($$anchor2) => {
      var text_5 = text("Agent server: online");
      append($$anchor2, text_5);
    };
    var alternate = ($$anchor2) => {
      var text_6 = text("Agent server: offline");
      append($$anchor2, text_6);
    };
    if_block(node_3, ($$render) => {
      if (get(agentStatus) === "checking") $$render(consequent_2);
      else if (get(agentStatus) === "online") $$render(consequent_3, 1);
      else $$render(alternate, -1);
    });
  }
  var button_2 = sibling(div_7, 4);
  template_effect(() => classes_3 = set_class(span_3, 1, "w-1.5 h-1.5 rounded-full svelte-c965ga", null, classes_3, {
    "bg-green-400": get(agentStatus) === "online",
    "bg-red-400": get(agentStatus) === "offline",
    "bg-gray-300": get(agentStatus) === "checking"
  }));
  delegated("click", button_2, openOptions);
  append($$anchor, div);
  pop();
}
delegate(["click"]);
...
//# sourceMappingURL=popup.html-BbOMuFEQ.js.map
